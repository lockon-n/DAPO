...
PT_SENTENCE_EVALUATION_SAMPLE = r"""
    Example::
...
TF_SENTENCE_EVALUATION_SAMPLE = r"""
    Example::
...
def add_code_sample_docstrings(*docstr, tokenizer_class=None, checkpoint=None, output_type=None, config_class=None):
    def docstring_decorator(fn):
        ...
        elif "Evaluation" in model_class:
            code_sample = TF_SENTENCE_EVALUATION_SAMPLE if is_tf_class else PT_SENTENCE_EVALUATION_SAMPLE
        else:
